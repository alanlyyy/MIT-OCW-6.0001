    ...
    def decrypt_message(self):
        ...
        for word in decrypt_words:
            if word in self.valid_words:
                decrypt_message_shift = (decrypt_words[word],) + (word,)
        
        return decrypt_message_shift
...
# =============================================================================
    ...
    message_list = get_story_string().split()
    message_print = []
    for message in message_list:    
        decrypt_story_text = CiphertextMessage(message)
        print(decrypt_story_text.get_message_text)
        message_print.append(decrypt_story_text.decrypt_message())
